...
<div class="grid_18">
	...
	<div class="box profile" id="tabs">
		...
		<div id="tab_asset">
			{assign var="details_view" value="{$category}_details_core.tpl"}
			
			{include file="{$details_view}"}
...
<div class="grid_6">
	<div class="box" style="padding-left: 5px;">{include "{$fcpath}application/modules/assets/views/actions_panel.tpl"}</div>
</div>
