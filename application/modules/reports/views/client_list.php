	...
	$(function() {
        ...
        $('#btn_submit').click(function() {
           ...
           if (output_type == 'view') {
               ...
               $('#results').load('<?php echo site_url('reports/client_list/jquery_display_results'); ?>' + '/' + output_type);

           }

           else {

               window.open('<?php echo site_url('reports/client_list/jquery_display_results'); ?>' + '/' + output_type);
...
<div class="grid_11" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<h3><?php echo $this->lang->line('client_list'); ?></h3>
