...
<?php if (uri_assoc('user_id') or $this->uri->segment(2) == 'profile') { ?>
	...
	<dl>
		<dt style="width: 150px;"><label><?php echo $this->lang->line('password'); ?>: </label></dt>
	...
	<dl>
		<dt style="width: 150px;"><label>* <?php echo $this->lang->line('password_verify'); ?>: </label></dt>
