...
/*
 ...
 |
 */
$config['rest_server']	= 'http://ce.tooljarlab.biz/index.php/api/'; //don't forget the trailing slash
$config['ce_key'] = 'aGB3DyLoE9KqIjYp7O21MRJd8CW6X0kgyGFtIrzjsS2nCp6eoHK1YZgmxfkR0qiJ';
